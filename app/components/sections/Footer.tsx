...
//         <div className="relative z-[1] fix-wide grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-x-[24px] gap-y-[40px] pt-[56px] lg:pt-[72px] pb-[8px]">
...
//               />
//             </Link>
//             <p className="max-w-[330px] font-sans text-[15px] leading-[22px] text-[#352c4a]">
//               {t({
        ...
        >
          ...
          {LINK_COLUMNS.map((col, i) => (
            <Reveal
              key={i}
              delay={0.05 + i * 0.05}
              className="w-[45%] sm:w-[22%] lg:w-[15%]"
            >
              <div
                className="mb-[12px] font-poppins text-[15px] font-semibold leading-[22px] tracking-[-0.2px] text-[var(--color-haiti)]"
                aria-hidden={!col.heading}
              ...
              <ul className="flex flex-col gap-[2px]">
                {col.links.map((l) => (
                  <li key={l.label.en}>
                    <Link
                      href={localizedHref(l.href, locale)}
                      className="block font-sans text-[15px] leading-[26px] text-[#463c5f] transition-colors hover:text-[var(--color-violet-42)]"
                    >
                      {t(l.label)}
                    </Link>
                  </li>
          ...
          {/* Contact Details */}
          <Reveal delay={0.2} className="w-full sm:w-[48%] lg:w-[25%]">
            <div className="mb-[12px] font-poppins text-[15px] font-semibold leading-[22px] tracking-[-0.2px] text-[var(--color-haiti)]">
              {t({ en: "Contact", nl: "Contact" })}
            </div>
            <div className="flex flex-col gap-[12px] font-sans text-[15px] leading-[21px] text-[#463c5f]">
              <p className="flex items-start gap-[9px] font-semibold">
                <MapPin
                  size={16}
                  className="mt-[3px] shrink-0 text-[var(--color-violet-42)]"
