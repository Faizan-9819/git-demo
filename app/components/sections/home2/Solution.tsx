...
//   features,
//   iconChipClass,
//   headerIconClass = "bg-[#E3FF54] text-[#21182f] rounded-2xl",
//   footNote,
//   linkLabel,
//   delay,
// }: {
...
//     <Reveal
//       delay={delay}
//       className={`relative flex h-full flex-col rounded-[28px] border border-white/10 p-6 sm:p-8 bg-[] ${gradient}`}
//     >
//       <div className="flex items-start justify-between gap-4">
//         <h3 className="m-0 font-poppins text-[22px] sm:text-[24px] font-bold leading-[1.2] text-white">
//           {titlePrefix ? t(titlePrefix) : ""}
...
//         </h3>
//         <span
//           className={`flex h-12 w-12 shrink-0 items-center justify-center !text-[#5b2dce] ${headerIconClass}`}
//         >
//           {headerIcon}
//         </span>
//       </div>
