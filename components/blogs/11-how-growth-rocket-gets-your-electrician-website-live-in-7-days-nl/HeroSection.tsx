...
const STEPS: HeroStep[] = [
  {
    label: "Jouw bedrijfsinformatie",
    sublabel: "Eén eenvoudige intake",
    icon: (
      <>
  ...
  {
    label: "Het Growth Rocket-systeem",
    sublabel: "Tekst · ontwerp · bouw · vindbaarheid, tegelijk",
    emphasis: true,
    icon: (
      <>
  ...
  {
    label: "Website live",
    sublabel: "Op je eigen domein, binnen 7 dagen",
    icon: (
      <>
  ...
  {
    label: "Klantaanvragen",
    sublabel: "Overzichtelijk op één plek",
    icon: (
      <>
    ...
    <section className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-[72px]">
      <div>
        ...
        <h1 className="mt-5.5 text-balance font-sans text-[34px] font-bold leading-[1.17] tracking-[-0.6px] text-[#1F2937] sm:text-[40px] sm:leading-[1.2] lg:text-[46px] lg:leading-[1.17]">
          Elektricienwebsite laten maken: zo staat hij met Growth Rocket binnen
          7 dagen online
        </h1>
        <p className="mt-6 max-w-[520px] text-pretty font-sans text-lg leading-8 text-[#6B7280] sm:text-xl">
          Niet door te haasten &mdash; maar door een project van zes tot twaalf
          weken te vervangen door een compleet, beheerd systeem dat de
          vertragingen wegneemt.
        </p>
