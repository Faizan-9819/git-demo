...
const BRIEF_ITEMS = [
  {
    title: "Zelf bouwen",
    detail: "€150–€400 per jaar · hoge tijdsinvestering",
    icon: (
      <>
  ...
  {
    title: "Freelancer",
    detail: "€1.500–€5.000 vooraf · maatwerk",
    icon: (
      <>
  ...
  },
  {
    ...
    detail: "€690 per jaar · alles geregeld",
    icon: (
      <>
    ...
    <section className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-[72px]">
      <div>
        ...
        <h1 className="mt-5.5 text-balance font-sans text-[34px] font-bold leading-[1.17] tracking-[-0.6px] text-[#1F2937] sm:text-[40px] sm:leading-[1.2] lg:text-[46px] lg:leading-[1.17]">
          Website zelf maken of laten maken? De eerlijke vergelijking voor
          elektriciens
        </h1>
        <p className="mt-6 max-w-[520px] text-pretty font-sans text-lg leading-8 text-[#6B7280] sm:text-xl">
          Drie eerlijke routes: zelf bouwen met Wix of WordPress, een freelancer
          inhuren, of een vast bedrag per jaar voor een volledig ontzorgde
          dienst. Geen verkooppraatje — alleen de afwegingen.
        </p>
        <div className="mt-9 flex flex-wrap items-center gap-4">
          <Button href="#decision" variant="primary" size="lg" arrow="up-right">
            Vergelijk de drie routes
          </Button>
          <a
            href="#tabel"
      ...
      <div className="rounded-2xl border border-[#E6E8EF] bg-[#FBFBFD] p-8.5 sm:p-9">
        ...
        <div className="mt-3.5 font-sans text-[13px] leading-[1.36] text-[#9AA1AC]">
          De juiste keuze hangt af van je tijd, je handigheid en je doel.
        </div>
      </div>
