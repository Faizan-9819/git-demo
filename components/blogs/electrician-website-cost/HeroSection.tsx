...
import PriceRangeCard, { type PriceRangeItem } from "@/components/blogs/shared/PriceRangeCard";
...
export default function HeroSection({
  ...
  return (
    <section className="grid gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
      ...
      <PriceRangeCard eyebrow={priceEyebrow} items={priceItems} footnote={priceFootnote} />
    </section>
  );
}
